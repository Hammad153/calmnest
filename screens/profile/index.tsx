...
export default function ProfileScreen() {
  ...
  return (
    <ScrollView
      ...
      <LinearGradient colors={["#E0F7FA", "#fff"]} className="px-4 pb-8">
        {/* Responsive container: stacks on mobile, two-column on md+ */}
        <View className="mt-12 px-4 md:flex md:flex-row md:items-start md:space-x-8">
          {/* Left: avatar + basic info */}
          <View className="flex items-center md:items-start md:w-1/3">
          ...
          <View className="mt-8 md:mt-0 md:w-2/3">
